...
% Host attributes -----------------------------------------------------------------
\renewcommand{\hostname}{192.168.1.1}
\renewcommand{\os}{Linux}
\renewcommand{\ip}{192.168.1.1}
\renewcommand{\tcpports}{21,22,80,443}
\renewcommand{\udpports}{53}
\renewcommand{\vuln}{Buffer overflow}
% \def\root{}
